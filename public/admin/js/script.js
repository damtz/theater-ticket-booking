...
// Chart 1 data
// Assuming moviesData is an array of objects with movie_name and tickets_sold properties
const moviesData = [
  { movie_name: 'Meto Pema', tickets_sold: 480 },
  { movie_name: 'The Cub', tickets_sold: 420 },
  { movie_name: 'Agay Zheom', tickets_sold: 405 },
  { movie_name: 'AP Bokto', tickets_sold: 390 },
  { movie_name: 'Bardo', tickets_sold: 376 },
];

// Extract movie names and corresponding tickets sold from moviesData
...
// The rest of your Chart.js code remains the same...
...
const percentageNormalRoom = (
  (chartData2.data[0] / totalTickets) *
  100
).toFixed(2);
const percentageVipRoom = ((chartData2.data[1] / totalTickets) * 100).toFixed(
  2
);
//
      ...
      tooltip: {
        callbacks: {
          ...
          label: (context) => {
            ...
            const value = context.raw;
            const percentage =
              index === 0 ? percentageNormalRoom : percentageVipRoom;
            return `${label}: ${value} (${percentage}%)`;
          },
        },
      },
...
const monthlyData = {
  ...
  datasets: [
    ...
    {
      label: 'Horror',
      data: [10, 11, 12, 13, 15, 14, 16, 14, 17, 18, 19, 22, 24, 25, 28, 27],
      borderColor: '#1be617',
      borderWidth: 2,
      fill: false,
    },
    {
      label: 'Comedy',
      data: [13, 14, 15, 16, 18, 19, 20, 22, 24, 25, 27, 28, 30, 31, 32, 35],
      borderColor: '#17e6da',
      borderWidth: 2,
      fill: false,
    },
    ...
    plugins: {
      ...
      datalabels: {
        ...
        formatter: (value, context) => {
          const index = context.dataIndex;
          return ['Romance', 'Drama', 'Horror', 'Comedy'][index] + ': ' + value;
        },
      },
    },
    layout: {
